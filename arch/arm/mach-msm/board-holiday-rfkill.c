...
static uint32_t holiday_bt_on_table[] = {
	...
	/* BT_RTS */
	GPIO_CFG(HOLIDAY_GPIO_BT_UART1_RTS,
				1,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_8MA),
	/* BT_CTS */
	GPIO_CFG(HOLIDAY_GPIO_BT_UART1_CTS,
				1,
				GPIO_CFG_INPUT,
				GPIO_CFG_PULL_UP,
				GPIO_CFG_8MA),
	/* BT_RX */
	GPIO_CFG(HOLIDAY_GPIO_BT_UART1_RX,
				1,
				GPIO_CFG_INPUT,
				GPIO_CFG_PULL_UP,
				GPIO_CFG_8MA),
	/* BT_TX */
	GPIO_CFG(HOLIDAY_GPIO_BT_UART1_TX,
				1,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_8MA),
...
static uint32_t holiday_bt_off_table[] = {
...
static struct rfkill_ops holiday_rfkill_ops = {
...
static int holiday_rfkill_remove(struct platform_device *dev)
{
...
static struct platform_driver holiday_rfkill_driver = {
	.probe = holiday_rfkill_probe,
	.remove = holiday_rfkill_remove,
	.driver = {
		.name = "holiday_rfkill",
		.owner = THIS_MODULE,
	},
...
static void __exit holiday_rfkill_exit(void)
{
	platform_driver_unregister(&holiday_rfkill_driver);
}
