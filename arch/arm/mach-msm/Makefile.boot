...
initrd_phys-$(CONFIG_MACH_BLISS)	:= 0x05400000
   zreladdr-$(CONFIG_MACH_SPADE)	:= 0x04408000
params_phys-$(CONFIG_MACH_SPADE)	:= 0x04400100
initrd_phys-$(CONFIG_MACH_SPADE)	:= 0x05400000
   zreladdr-$(CONFIG_MACH_MECHA)	:= 0x05008000
params_phys-$(CONFIG_MACH_MECHA)	:= 0x05000100
initrd_phys-$(CONFIG_MACH_MECHA)	:= 0x06000000
