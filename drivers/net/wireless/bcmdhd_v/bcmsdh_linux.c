...
int bcmsdh_v_probe(struct device *dev);
int bcmsdh_v_remove(struct device *dev);

EXPORT_SYMBOL(bcmsdh_v_probe);
EXPORT_SYMBOL(bcmsdh_v_remove);

#else
/* forward declarations */
static int __devinit bcmsdh_v_probe(struct device *dev);
static int __devexit bcmsdh_v_remove(struct device *dev);
#endif /* BCMLXSDMMC */
...
static struct device_driver bcmsdh_driver = {
	...
	.probe		= bcmsdh_v_probe,
	.remove		= bcmsdh_v_remove,
	.suspend	= NULL,
	.resume		= NULL,
	};
#endif /* BCMLXSDMMC */
