...
struct s5k3h2yx_i2c_reg_conf s5k3h2yx_common_settings_array_mipi[] =
{
  ...
  { 0x3011 , 0x5F },
  { 0x3156 , 0xE2 },
  /*{ 0x3027 , 0x0E },*/ /* For 648Mbps */
  { 0x3027 , 0xBE }, /* For 912Mbps */
  { 0x300f , 0x02 },
  { 0x3010 , 0x10 },
  { 0x3017 , 0x74 },
  { 0x3018 , 0x00 },
  ...
  { 0x301C , 0xD4 },
  { 0x315D , 0x00 },
  { 0x3053 , 0xCF }, /* CF for full ,CB for preview/HD/FHD/QVGA120fps move to  size configure */
  { 0x3054 , 0x00 }, /* For 912Mbps */
  { 0x3055 , 0x35 },
  { 0x3062 , 0x04 },
  { 0x3063 , 0x38 },
  /*{ 0x301A , 0xC4 },*/
...
struct s5k3h2yx_i2c_reg_conf s5k3h2yx_qtr_settings_array_mipi[] =
{
  ...
  { 0x31A3 , 0x40 }, /* Reserved */ /* For 912Mbps */
  { 0x301A , 0xA7 }, /* Reserved */ /* For 912Mbps */
  { 0x3053 , 0xCF }, /* CF for full/preview/ ,CB for HD/FHD/QVGA120fps */
};
...
struct s5k3h2yx_i2c_reg_conf s5k3h2yx_fast_video_settings_array_mipi[] =
{
  { 0x0305 , 0x04 }, /* pre_pll_clk_div = 4 */
  { 0x0306 , 0x00 }, /* pll_multiplier */
  { 0x0307 , 0x98 }, /*912MHz*/  /* pll_multiplier  = 152 */
  { 0x0303 , 0x01 }, /* vt_sys_clk_div = 1 */
  { 0x0301 , 0x05 }, /* vt_pix_clk_div = 5 */
  { 0x030B , 0x01 }, /* op_sys_clk_div = 1 */
  { 0x0309 , 0x05 }, /* op_pix_clk_div = 5 */
  { 0x30CC , 0xE0 }, /*912MHz*/  /* DPHY_band_ctrl 870 MHz ~ 950 MHz */
  ...
  { 0x0342 , 0x0D }, /* Line_length_pck 3470d */
  { 0x0343 , 0x8E },
  { 0x0340 , 0x03 }, /* Frame_length_lines 876d */
  { 0x0341 , 0x6C },
